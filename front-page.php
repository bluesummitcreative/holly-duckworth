<?php 
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-7 text-center">
					...
					<p><a class="btn btn-mindfulness btn-lg" href="https://itunes.apple.com/us/podcast/everyday-mindfulness-show/id1209227878" target="_blank">Listen Now</a></p>
				</div>
				<div class="col-sm-5 text-center">
					<a href="https://itunes.apple.com/us/podcast/everyday-mindfulness-show/id1209227878" target="_blank"><img class="img-fluid" src="/wp-content/uploads/2018/08/itunes.png" alt="everyday mindfulness show"></a>
				</div>
			</div>
		</div>
	</div>
	<div class="container-fluid text-center container-padding">
		<div class="container">
			<div class="row">				
					<h4 class="col-12" style="margin:0 0 40px;">Holly has written for the following publications:</h4>
					<div class="row">
