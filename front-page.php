		...
		<div class="container">
			<div class="row">
				<div class="col-sm-7 text-center">
					...
					<p><a class="btn btn-mindfulness btn-lg" href="http://www.everydaymindfulnessshow.com/" target="_blank">Listen Now</a></p>
				</div>
				<div class="col-sm-5 text-center">
					<a href="http://www.everydaymindfulnessshow.com/" target="_blank"><img class="img-fluid" src="/wp-content/uploads/2018/08/itunes.png" alt="everyday mindfulness show"></a>
				</div>
			</div>
		</div>
	</div>
