...
<?php } else { ?>
<div class="container-fluid page-header" style="background:background: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ),url(<?php if ( get_field( 'page_header_image' ) ): the_field('page_header_image'); else: header_image(); endif;?>) no-repeat;background-size:cover;background-position:center center;">
<?php } ?>
	<div class="container">
		<div class="row">
